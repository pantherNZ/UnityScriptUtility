...
public static partial class Utility
{
    ...
    */
	...
	public static Rect ToRectXZ( this Bounds bound ) { return new Rect( bound.center.XZ() - bound.extents.XZ(), bound.size.XZ() ); }
	public static Rect ToRect( this RectInt rect ) { return new Rect( rect.position, rect.size ); }
